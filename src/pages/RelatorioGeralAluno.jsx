...
function RelatorioGeralAluno() {
    ...
    const downloadCSV = () => {
        ...
        link.href = url;
        link.download = "relatorio_geral_alunos.csv";
        ...
        <div style={{ backgroundColor: '#f8f9fa', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <Container className="flex-grow-1">
                ...
                <Row className="mb-5 g-4">
                    <Col md={6}>
                        <Card className="border-0 shadow-sm p-3 h-100">
                            <h6 className="fw-bold text-dark">Tutorandos que desejam continuar sendo acompanhados</h6>
                            <ResponsiveContainer width="100%" height={200}>
                ...
                <Row className="mb-5 g-4">
                    ...
                    <Col md={6}>
                        <Card className="border-0 shadow-sm p-3 mb-4">
                            ...
                            <Table hover responsive borderless size="sm" className="text-muted">
                                <thead className="border-bottom">
                                    <tr><th>Matrícula</th><th>Nome</th><th>Avaliação</th></tr>
                                </thead>
                                <tbody>
                                    {dadosDashboard.avaliacaoTutores.map((tuto, i) => (
                                        <tr key={i}>
                                            <td>{tuto.id}</td>
                                            <td>{tuto.nome}</td>
                                            <td>{tuto.avaliacao}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </Table>
